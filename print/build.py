...
SP = pathlib.Path('/tmp/claude-0/-home-user-digital-narratives-schedule/dd399f8e-4d44-5fdd-b359-053720b85337/scratchpad')
...
body = (HERE / 'body.html').read_text().replace('__LOGO__', b64(HERE/'bac_logo.png','image/png'))

# Colors sampled from the Fall 2025 PDF
RULE_BLUE  = '#4F81BD'   # letterhead rule
TITLE_BLUE = '#006FC0'   # DME2100 - Digital Narratives
GRAY_HEAD  = '#A6A6A6'   # grade table column header row
LINK_BLUE  = '#1155CC'   # hyperlinks

html = f"""<!DOCTYPE html>
<html lang="en"><head><meta charset="UTF-8"><title>DME2100 Digital Narratives Syllabus Fall 2026</title>
<style>
{chr(10).join(faces)}
